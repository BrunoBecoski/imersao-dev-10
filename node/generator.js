...
const responseSchema = {
  ...
  items: {
    ...
    properties: {
      ...
      "description": { "type": "STRING", "description": "Descrição concisa da tecnologia." },
...
async function generateNewKnowledge(existingKnowledge) {
  ...
  const userQuery = `Gere uma lista de ${TOTAL_ITEMS} novas tecnologias. Siga estritamente a estrutura JSON e o requisito de ser um ARRAY com EXATAMENTE ${TOTAL_ITEMS} objetos. INCLUA as 9 tecnologias iniciais (JavaScript, Python, Java, C#, C++, PHP, TypeScript, Ruby, Go) e NÃO use NENHUM dos seguintes nomes: ${existingNames}.`;
